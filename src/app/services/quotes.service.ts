...
export class QuotesService {
    ...
    getDummyQuotes(): Observable<Quote[]> {
        return this.__httpClient
            .get<DummyQuotes>(environment.dummyQuotesUrl)
            .pipe(
                map((response) =>
    ...
    getQuotesGardeQuote(): Observable<Quote[]> {
        return this.__httpClient
            .get<QuotesGardenQuotes>(environment.quotesGardenUrl)
            .pipe(
                map((response) =>
    ...
    getQuotableQuotes(): Observable<Quote[]> {
        return this.__httpClient
            .get<QuotableQuotes>(environment.quotableUrl)
            .pipe(
                map((response) =>
    ...
    getAllQuotes(): Observable<Quote[]> {
        return race(
            this.getDummyQuotes(),
            this.getQuotesGardeQuote(),
            this.getQuotableQuotes()
        )
    }
